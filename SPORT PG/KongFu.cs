...
namespace SPORT_PG
{
    public partial class KongFu : Form
    {
        ...
        private void KongFu_Load(object sender, EventArgs e)
        {
        ...
        private void KongFu_MouseDown(object sender, MouseEventArgs e)
        {
            PZ = 1;
            posX = e.X;
            posY = e.Y;
        ...
        private void KongFu_MouseUp(object sender, MouseEventArgs e)
        {
            PZ = 0;
        }
        ...
        private void KongFu_MouseMove(object sender, MouseEventArgs e)
        {
            if (PZ == 1)
            {
        ...
        void image()
        {
            cmd = new SqlCommand("select * From client Where CIN like '%" + bunifuTextbox1.text + "%' and typeC = 'KONGF'", cn);
            cn.Open();
